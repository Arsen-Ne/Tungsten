...
import trigonal.tungsten.database.repository.UserRepository;
    ...
    public User registerNewUserAccount(UserDTO userDto) throws UserAlreadyExistsException {
        ...
        if (!user.getEmail().isEmpty()) {
            String message = String.format(
                "Hello, %s! \n" +
                        "Welcome to Tungsten. Please, click the link to confirm your email: http://25.23.19.72:8080/signup/activate/%s",
                user.getUserName(),
